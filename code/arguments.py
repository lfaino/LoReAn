...
def setting():
    ...
    parser.add_argument("-f","--fungus", help="Use this option for fungal species (used in Gene Mark-ES) [FALSE]",
                        action='store_true')
    parser.add_argument("-iprs","--interproscan", help="Use interproscan for functional annotation of the predicted proteins [FALSE]",
                        action='store_true')
    ...
    parser.add_argument("-g","--min_intron_length", nargs="?", default="9", help="Minimal intron length for GMAP [9]",
                        metavar='N')
    parser.add_argument("-q","--max_intron_length", nargs="?", default="10000", help="Maximal intron length for GMAP, STAR "
